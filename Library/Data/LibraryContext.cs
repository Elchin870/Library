...
public partial class LibraryContext : DbContext
{
    ...
    public virtual DbSet<MaximumPage> MaximumPages { get; set; }
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        ...
        => optionsBuilder.UseSqlServer("Data Source=DESKTOP-HMRVE90;Initial Catalog=Library;Integrated Security=True;Connect Timeout=30;Encrypt=True;Trust Server Certificate=True;Application Intent=ReadWrite;Multi Subnet Failover=False");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<MaximumPage>(entity =>
        {
            entity
                .HasNoKey()
            .ToView("MaximumPage");
